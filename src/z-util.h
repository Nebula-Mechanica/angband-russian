...
extern int a_toupper(int c);
extern int a_tolower(int c);
extern int a_isupper(int c);
extern int a_islower(int c);
extern int a_isalpha(int c);
extern int a_isprint(int c);
